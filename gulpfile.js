...
let path = { // содержит объекты которые будут содержать различные пути к файлам и папкам
    ...
    src: { // исходники
        ...
        img: sourceFolder + '/img/**/*.{png,jpg,svg,webp,gif,ico,pdf,mp4,mp3}',// /**/ означает что мы будем просматривать не только контент в папке /img, но и контент внутри папок которые лежат в /img, *.{png,jpg,svg,webp,gif,ico} указывает на то, что мы просматриваем только файлы с расширениями png,jpg,svg,webp,gif,ico
    ...
    watch: { // будем использовать для live reload
        ...
        img: sourceFolder + '/img/**/*.{png,jpg,svg,webp,gif,ico,pdf,mp4,mp3}'
